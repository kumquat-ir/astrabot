...
def command_with_help(*args, **kwargs):

    def decorator(func):
        fname = func.__name__
        return bot.command(*args, **kwargs, help=helpdb[fname], usage=usagedb[fname], brief=briefdb[fname])(func)
...
@command_with_help(aliases=["textbox"])
